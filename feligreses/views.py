...
def editar_feligres(request, iglesia_id, feligres_id):
    ...
    return render(request, 'feligreses/editar.html', {'form': form, 'iglesia': iglesia, 'feligres': feligres})
...
def eliminar_feligres(request, iglesia_id, feligres_id):
    ...
    if request.method == "POST":
        feligres.delete()
        return redirect('lista_feligreses', iglesia_id=iglesia.id)
    return render(request, 'feligreses/eliminar.html', {'feligres': feligres, 'iglesia': iglesia})
